...
{
    // Initialize the alphabet to use
    ...
    ProgramSettings programSettings {false, false, "", "", "", mode};
    ...
    // Initialize the CaesarCipher class    
    CaesarCipher cipher = CaesarCipher(programSettings.cipherKey, alphabet);

    // Run the Caesar cipher (using the encrypt/decrypt flag) on the input text
    std::string outputText{cipher.applyCipher(inputText, programSettings.mode)};
