...
bool processCommandLine(const std::vector<std::string>& cmdLineArgs, ProgramSettings& programSettings)
{
    ...
    for (std::size_t i{1}; i < nCmdLineArgs; ++i) {
        if (cmdLineArgs[i] == "-h" || cmdLineArgs[i] == "--help") {
            ...
            if (i == nCmdLineArgs - 1) {
                ...
                programSettings.inputFile = cmdLineArgs[i + 1];
                ++i;
            }
            ...
            if (i == nCmdLineArgs - 1) {
                ...
                // Got filename, so assign value and advance past it
                programSettings.outputFile = cmdLineArgs[i + 1];
                ++i;
            }
            ...
            if (i == nCmdLineArgs - 1) {
                ...
                programSettings.cipherKey = cmdLineArgs[i + 1];
                ++i;
            }
